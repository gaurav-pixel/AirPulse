...
def make_report(payload: ReportIn) -> bytes:
    ...
    # Header
    story.append(Paragraph("<para alignment='center'><b>AirPulse</b></para>", title_style))
    ...
    story.append(separator())
    story.append(Paragraph("<para alignment='center'>Generated by AirPulse</para>", normal_style))
